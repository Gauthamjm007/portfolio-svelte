<main class="w-full min-h-screen font-sans bg-black">
     <div class="container px-6 py-4 mx-auto text-white md:py-8 md:px-14 lg:py-0 lg:flex">
     <div class="lg:w-1/3 lg:py-20 lg:h-screen lg:flex lg:flex-col lg:flex-start">
            <div >
              <h1 class="mb-6 text-6xl font-semibold leading-tight">
                Hello, I'm Goutham JM
              </h1>
              <p class="mb-6 leading-loose text-dawn">
                I'm a Fullstack developer. Building websites, for nearly 3 years. Currently
                working at <span class="text-blue-400">DesignString</span>{" "}<br/>
                I am a JS enthusiast{" "}.
              </p>
            </div>
            <div class="hidden text-gray-500 lg:block py-12">
                <a class="inline-flex items-center w-full py-2">
                  1.Experience
                </a>
            ...
            <div class="flex items-center mb-14 lg:block">
              <div class="flex items-center ml-12 space-x-6 lg:ml-0 lg:flex-col lg:items-start lg:space-y-4 lg:space-x-0">
             
                <a
                  class="flex items-baseline md:space-x-3 hover:text-gray-500"
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                    class="w-6 h-6 fill-current md:w-4 md:h-4"
                  >
                  ...
                  <div class="hidden md:block">
                    <svg
                      ...
                      viewBox="0 0 12 12"
                      aria-hidden="true"
                      class="flex-none w-3 h-3 stroke-current"
                    >
                ...
                <a
                  class="flex items-baseline md:space-x-3 hover:text-gray-500"
                  href="https://in.linkedin.com/in/gouthamjm"
                  rel="noopener"
                  target="_blank"
                >
                  <svg
                ...
                <a
                  class="flex items-center tbaseline md:space-x-3 hover:text-gray-500"
                ...
                >
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                    aria-hidden="true"
                    class="fill-current w-7 h-7 md:w-5 md:h-5"
                  >
                  ...
                  <span class="hidden md:block">Dev</span>
                  <div class="hidden md:block">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                ...
                <a
                  class="flex items-center tbaseline md:space-x-3 hover:text-gray-500"
                  href="https://drive.google.com/file/d/1THJw5eDxc1wig7vj7bQqedpU6qF6KLdH/view?usp=sharing"
                  rel="noopener"
                  target="_blank"
                >
                  <svg
